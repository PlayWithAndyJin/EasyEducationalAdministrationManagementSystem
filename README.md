...
<a href="README_en.md">简体中文</a> | English<br><br>
## 项目简介
...
本系统以南通理工学院新版正方教务管理系统为例开发。只要你的学校使用的是新版正方教务管理系统（即新版“正方教务系统”Web端），均可直接使用本程序，无需修改核心代码。
...
1. **找到你学校教务系统的网址**  
   ...
   ```
   例如：
   - 南通理工学院为 `https://zfjw.ntit.edu.cn/jwglxt/`
